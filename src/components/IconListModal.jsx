...
const IconListModal = ({
  ...
  const [icons, setIcons] = useState(lucideIconLists.slice(0, 400));
  ...
  const handleModalClose = () => {
    setIsOpen(false);
    setIcons(lucideIconLists.slice(0, 400));
    setSearchTerm("");
  };
...
//   const [icons, setIcons] = useState(lucideIconLists);
//   const [searchTerm, setSearchTerm] = useState("");

//   const handleOnSearch = (search = "") => {
//     setSearchTerm(search);

//     const searchedIcons = lucideIconLists.filter((icon) => {
//       return icon
//         .toLowerCase()
//         .includes(search.split(" ").join("").toLowerCase());
//     });
...
//   const handleModalClose = () => {
//     setIsOpen(false);
//     setIcons(lucideIconLists);
//     setSearchTerm("");
//   };

//   return (
//     <div
//       className={`fixed inset-0 z-[1001] flex ${isOpen ? "translate-y-0" : "-translate-y-[100%]"} items-start justify-center`}
//     >
//       <div
//         onClick={() => !disableOverlayClick && handleModalClose()}
//         className="fixed inset-0 z-10 bg-black bg-opacity-40"
