...
const About = () => {
  ...
  return (
    <div className="body-height overflow-auto">
      <div className="flex h-[450px] flex-col items-center justify-center gap-5 bg-red-500 bg-[url('/about_bg.png')] bg-cover bg-no-repeat">
      ...
      <div className="mx-auto mt-20 max-w-screen-xl px-3">
        ...
        <div className="mt-8 grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-6">
          {Array(7)
            .fill(0)
            .map((_, i) => (
              <div className="group aspect-square cursor-pointer border border-dashed bg-transparent transition hover:border-transparent hover:bg-slate-200 ">
                <img
